...
namespace OA_Game.Items
{
    ...
    public class Note : Item
    {
        public Note(int height, int width, ImageSource defaultSprite) : base(height, width, defaultSprite)
        {
            ...
            {
                new BitmapImage(Assets.GetUri("Images/Cap/Note_1.png")),
                new BitmapImage(Assets.GetUri("Images/Cap/Note_2.png")),
                new BitmapImage(Assets.GetUri("Images/Cap/Note_3.png")),
                new BitmapImage(Assets.GetUri("Images/Cap/Note_4.png")),
                new BitmapImage(Assets.GetUri("Images/Cap/Note_5.png")),
                new BitmapImage(Assets.GetUri("Images/Cap/Note_6.png"))
            });
